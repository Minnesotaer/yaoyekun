...
<head lang="en">
    ...
    <!-- Bootstrap core CSS -->
    <link href="/lxbus/Application/Admin/View//Public/static/css/bootstrap.css" rel="stylesheet">

    <!-- Add custom CSS here -->
    <link href="/lxbus/Application/Admin/View//Public/static/css/sb-admin.css" rel="stylesheet">
...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <form action="<?php echo U('login/login');?>" method="post" role="form">
...
<script src="/lxbus/Application/Admin/View//Public/static/js/jquery-1.10.2.js"></script>
<script>
    $(function(){
        $(".verify").click(function(){
            var src = "<?php echo U('Admin/Login/verify');?>";
