...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <caption>
	   <input type="date"  name="keyword" id="keyword" value="<?php echo ($keyword); ?>"  />
	   到
	   <input type="date" name="keyword1" id="keyword1" value="<?php echo ($keyword1); ?>"  />
	<!--<input type="text" name="keyword" id="keyword" value="<?php echo ($keyword); ?>" placeholder="用户手机或名称">-->
   ...
   <tbody>
	  <?php if(is_array($userlist)): foreach($userlist as $key=>$v): ?><tr id="user-<?php echo ($v["user_id"]); ?>">
         <td><?php echo ($v["id"]); ?></td>
         <td><?php echo ($v["user_id"]); ?></td>
         <td><?php echo ($v["msg_type"]); ?></td>
		  <td><?php echo ($v["message"]); ?></td>
         <td><?php echo ($v["is_read"]); ?></td>
		  <td><?php echo (date("Y-m-d H:m",$v["$v"]["create_time"])); ?></td>
		  <td><?php echo (date("Y-m-d H:m",$v["$v"]["read_time"])); ?></td>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
			...
			<div class="form-group">
			<label class="col-sm-2 control-label">是否可读</label>
			<div class="col-sm-10">
...
$(document).ready(function(e) {
	$('.edit-userdata').click(function(){
		...
		$(':input[name="phone"]').val($(this).parent().siblings().eq(2).text());
		$(':input[name="email"]').val($(this).parent().siblings().eq(3).text());
		$(':input[name="real_name"]').val($(this).parent().siblings().eq(4).text());
...
//		var keyword1=$('#keyword1').val();
		var url = "<?php echo U('index');?>?keyword="+keyword+"&keyword1="+keyword1;
