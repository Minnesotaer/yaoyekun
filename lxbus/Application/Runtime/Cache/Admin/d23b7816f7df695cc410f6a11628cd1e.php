...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <caption>
	<input type="text" name="keyword" id="keyword" value="<?php echo ($keyword); ?>" placeholder="店铺名称或企业名称"><input type="button" name="serach" id="search" value="搜索">
   ...
   <tbody>
	  <?php if(is_array($imagelist)): $i = 0; $__LIST__ = $imagelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
         <td><?php echo ($v["id"]); ?></td>
         <td><?php echo (getkbcompanyname($v["company_id"])); ?></td>
         <td><?php echo ($v["name"]); ?></td>
		 <td><?php echo ($v["imgnum"]); ?>
		 
		
		 </td>
		   <td><?php if($v[pic_url] != ''): ?><img src="/lxbus/<?php echo ($v["pic_url"]); ?>" height="100" width="100"><?php endif; ?></td>
   <td><a href="<?php echo U('Admin/Koubei/myalbum');?>?id=<?php echo ($v["id"]); ?>">查看</a>
			</td>
  
		 </tr><?php endforeach; endif; else: echo "" ;endif; ?>
	  <tr>
		<td colspan="12" class="mypage"><?php echo ($page); ?></td>
	  </tr>
   </tbody>
</table>
	</section>
...
$(document).ready(function(e) {
	...
	var url = "<?php echo U('delcommemt');?>?id="+id;
	...
	var url = "<?php echo U('album');?>?keyword="+keyword;
