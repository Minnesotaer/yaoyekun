  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li><a href="<?php echo U('Koubei/stop');?>" <?php if($myaction == 'shopapply'): ?>style="color:#fff;"<?php endif; ?>><i class="fa fa-circle-o text-aqua"></i>商家申请</a></li>
		</ul>		
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <caption style="font-size:22px;">角色列表</caption>
   <caption style="font-size:22px;border-bottom:1px solid #ccc;">
   <a class="btn btn-default" href="<?php echo U('Admin/Rbac/addRole');?>" >添加角色</a>
   </caption>
   <thead>
      <tr>
         <th>ID</th>
   ...
   <tbody>
	  <?php if(is_array($role)): foreach($role as $key=>$v): ?><tr>
				  ...
				  <td><?php if($v['status']): ?><span class="label label-primary">正常<?php else: ?><span class="label label-danger">关闭</span><?php endif; ?></td>
                  <td>
					<div class="btn-group">
					  <a href="<?php echo U('Rbac/access', array('rid' => $v['id']));?>" class="btn btn-default btn-xs">配置</a> <a href="<?php echo U('Admin/Rbac/del_role',array('id'=>$v['id']));?>" class="btn btn-danger btn-xs">删除</a>
					</div>
				  </td>
