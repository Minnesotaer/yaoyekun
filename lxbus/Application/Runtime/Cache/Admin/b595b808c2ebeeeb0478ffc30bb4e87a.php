...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<section class="content-header">
	  <div>
		<p style="color:#cc0000;">提醒</p>
		<?php if($views_data[cptxnum] > 0): ?><div style="float:left;padding:5px;border:1px solid #ccc;margin-right:6px;"><a href="<?php echo U('Admin/Caiwu/cpwithdraw');?>" style="font-size:18px;color:#cc0000;">有<?php echo ($views_data[cptxnum]); ?>个商家提现未处理</a></div><?php endif; ?>
		
		<?php if($views_data[cstxnum] > 0): ?><div style="float:left;padding:5px;border:1px solid #ccc;margin-right:6px;"><a href="<?php echo U('Admin/Caiwu/cswithdraw');?>" style="font-size:18px;color:#cc0000;">有<?php echo ($views_data[cstxnum]); ?>个消费者提现未处理</a></div><?php endif; ?>

		<?php if($views_data[mntxnum] > 0): ?><div style="float:left;padding:5px;border:1px solid #ccc;margin-right:6px;"><a href="<?php echo U('Admin/Caiwu/mnwithdraw');?>" style="font-size:18px;color:#cc0000;">有<?php echo ($views_data[mntxnum]); ?>个业务员提现未处理</a></div><?php endif; ?>

		<?php if($views_data[userrz] > 0): ?><div style="float:left;padding:5px;border:1px solid #ccc;margin-right:6px;"><a href="<?php echo U('Admin/User/userapply');?>" style="font-size:18px;color:#cc0000;">有<?php echo ($views_data[userrz]); ?>个个人认证未处理</a></div><?php endif; ?>
		
		<?php if($views_data[companyrz] > 0): ?><div style="float:left;padding:5px;border:1px solid #ccc;margin-right:6px;"><a href="<?php echo U('Admin/User/cprz');?>" style="font-size:18px;color:#cc0000;">有<?php echo ($views_data[companyrz]); ?>个企业认证未处理</a></div><?php endif; ?>
		
		<?php if($views_data[managerup] > 0): ?><div style="float:left;padding:5px;border:1px solid #ccc;margin-right:6px;"><a href="<?php echo U('Admin/User/mnupgrade');?>" style="font-size:18px;color:#cc0000;">有<?php echo ($views_data[managerup]); ?>个业务员升级未处理</a></div><?php endif; ?>
	  </div>
	...
	<?php if($_SESSION[C('ADMIN_AUTH_KEY')] != ''): ?><section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo ($views_data["bzbcount"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Bzb/bz');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo ($views_data["cscount"]); ?></h3>

              <p>消费者(<?php echo ($views_data["chekuser"]); ?>个已认证)</p>
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
            <a href="<?php echo U('Admin/User/cs');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo ($views_data["cpcount"]); ?></h3>

              <p>商家(<?php echo ($views_data["chekcompany"]); ?>个已认证)</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
            <a href="<?php echo U('Admin/User/cp');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo ($views_data["mncount2"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/User/mn',array('mntype'=>0));?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo ($views_data["mncount"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/User/mn',array('mntype'=>1));?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo ($views_data["fgscount"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Fengongshi/fgslist');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo ($views_data["moneycount"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Bzb/order');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo ($views_data["charges"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/charge');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo ($views_data["cpmoney"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/cpyue');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo ($views_data["cpoutmoney"]); ?></h3>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo ($views_data["csoutmoney"]); ?></h3>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo ($views_data["csmoney"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/csyue');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo ($views_data["mnmoney"]); ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/mnyue');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php if($views_data[cpwithdraw] != ''): echo ($views_data["cpwithdraw"]); else: ?>0<?php endif; ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/cpwithdraw');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php if($views_data[mnwithdraw] != ''): echo ($views_data["mnwithdraw"]); else: ?>0<?php endif; ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/mnwithdraw');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php if($views_data[cswithdraw] != ''): echo ($views_data["cswithdraw"]); else: ?>0<?php endif; ?></h3>
            ...
            <a href="<?php echo U('Admin/Caiwu/cswithdraw');?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
      <!-- /.row -->
	...
	<?php else: ?>
	<p style="padding:12px;font-size:18px;">报账宝欢迎您！</p><?php endif; ?>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
