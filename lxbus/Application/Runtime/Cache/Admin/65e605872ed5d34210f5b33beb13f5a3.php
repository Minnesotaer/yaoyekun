...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <caption>
	...
	<input type="text" name="keyword" id="keyword2" value="<?php echo ($keyword2); ?>" placeholder="用户名">
...
//		var keyword=$('#keyword').val();
	...
	var url = "<?php echo U('index');?>?keyword="+keyword+"&keyword1="+keyword1+"&keyword2="+keyword2;
